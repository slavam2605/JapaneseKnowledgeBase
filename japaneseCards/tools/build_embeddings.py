...
def fetch_pending_notes(
        ...
        where.append(
            ...
            NOT EXISTS (
                ...
                WHERE e.deck_name = n.deck_name
                  ...
                  AND e.dimension_key = ?
                  AND e.source_content_hash = n.embedding_hash
            )
            """
        )
    ...
    sql = f"""
        SELECT n.deck_name, n.note_id, n.front_clean, n.embedding_text, n.embedding_hash
        FROM anki_notes n
        ...
        values.append(
            {
                ...
                "source_content_hash": row["embedding_hash"],
